...
def encontrar_menores(diccionario,letra):
    ...
    """El problema era que la lista resultado se creaba dentro del for, por lo que cada vez que se producía una iteración, se vaciaba la lista.
    Esto se arregla declarando la lista fuera del bucle for"""
    resultado=[]
